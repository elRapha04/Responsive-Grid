    ...
    >
      ...
      >
        <div id="group-div" className="flex h-full">
          <div
            id="inDiv"
            className="size-full rounded-3xl border-2 bg-white/20 border-black flex justify-center items-center group transition-all duration-500 hover:border-green-500 hover:backdrop-blur hover:bg-gradient-to-tr from-indigo-500/50 via-cyan-700/50 to-pink-500/50 hover:border-8"
          >
        ...
        >
          <div
            id="inDiv"
            className="size-full rounded-3xl border-2 bg-white/20 border-black flex justify-center items-center group flex-[1] hover:flex-[2] transition-all duration-500 hover:border-green-500 hover:backdrop-blur hover:bg-gradient-to-tr from-indigo-500/50 via-cyan-700/50 to-pink-500/50 hover:border-8"
          >
        ...
        >
          <div
            id="inDiv"
            className="size-full rounded-3xl border-2 bg-white/20 border-black flex justify-center items-center transition-all duration-500 flex-[1] group hover:flex-[2] hover:border-green-500 hover:backdrop-blur hover:bg-gradient-to-tr from-indigo-500/50 via-cyan-700/50 to-pink-500/50 hover:border-8"
          >
